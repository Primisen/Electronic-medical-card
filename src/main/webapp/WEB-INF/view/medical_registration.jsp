...
<div class=" position-relative mt-5 mb-5 start-50 translate-middle-x" style="max-width: 500px">
    ...
    <div class="row g-3">
        <form:form method="POST" modelAttribute="userForm">
            <h2>Регистрация медицинского работника</h2>

            <label class="form-label">Имя</label>
            <form:input type="text" path="name" placeholder="Имя" cssClass="form-control mb-3" autofocus="true"/>

            <label class="form-label">Фамилия</label>
            <form:input type="text" path="surname" placeholder="Фамилия" cssClass="form-control mb-3"/>

            <label class="form-label">Отчество</label>
            <form:input type="text" path="patronymic" placeholder="Отчество" cssClass="form-control mb-3"/>
